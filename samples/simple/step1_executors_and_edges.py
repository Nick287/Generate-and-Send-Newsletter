...
async def main():
    ...
    # Export workflow topology as PNG images
    # https://github.com/microsoft/agent-framework/tree/main/python/samples/03-workflows
    # WorkflowViz(workflow1).export(format="png", filename="samples/workflow1_executors_and_edges")
    # print("\nExported: samples/workflow1_executors_and_edges.png")
    # WorkflowViz(workflow2).export(format="png", filename="samples/workflow2_executors_and_edges")
    # print("Exported: samples/workflow2_executors_and_edges.png")
